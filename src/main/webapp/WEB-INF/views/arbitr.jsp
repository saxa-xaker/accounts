...
<div style="width: 1080px;position: absolute;top:510px">
    ...
    <spring:bind path="sro_document_date">
        ...
        <div class="form18 ${status.error ? 'has-error' : ''}">
...
<div style="width: 1080px;position: absolute;top:590px">
    ...
    <spring:bind path="tender_manager_count">
        ...
        <div class="form25 ${status.error ? 'has-error' : ''}">
...
<div style="width: 1080px;position: absolute;top:660px">
   ...
   <spring:bind path="bankrot_company_name">
       ...
       <div class="form27 ${status.error ? 'has-error' : ''}">
    ...
    <spring:bind path="bankrot_company_address">
        ...
        <div class="form26 ${status.error ? 'has-error' : ''}">
    ...
    <spring:bind path="bankrot_end_date_manage">
        ...
        <div style="width: 1080px;position: absolute;top:660px">
            ...
            <spring:bind path="violation_discharge_of_manager">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="violation_discharge_of_manager" class="form-control"
                                placeholder="Отстранение от исполнения
обязанностей в деле о банкротстве да\нет"></form:input>
                    <form:errors path="violation_discharge_of_manager"></form:errors>
                </div>
            </spring:bind>
...
обязанностей в деле о банкротстве в связи с: подробно"></form:input>
            ...
            <spring:bind path="violation_law_manager">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="violation_law_manager" class="form-control"
                                placeholder="Укажите, применялись ли к Вам за истекший год меры ответственности, да\нет"></form:input>
                    <form:errors path="violation_law_manager"></form:errors>
                </div>
            </spring:bind>
            ...
            <spring:bind path="violation_requirement_compensation_harm_manager">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="violation_requirement_compensation_harm_manager" class="form-control"
                                placeholder="Предъявлялись ли требования о возмещении вреда"></form:input>
                    <form:errors path="violation_requirement_compensation_harm_manager"></form:errors>
                </div>
            </spring:bind>
            ...
            <spring:bind path="violation_pending_complaints">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="violation_pending_complaints" class="form-control"
                                placeholder="Имеются ли нерассмотренные жалобы на ненадлежащее исполнение Вами своих обязанностей да\нет"></form:input>
                    <form:errors path="violation_pending_complaints"></form:errors>
                </div>
            </spring:bind>
            ...
            <spring:bind path="violation_complaints_considered">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="violation_complaints_considered" class="form-control"
                                placeholder="Имеются ли рассмотренные жалобы на ненадлежащее исполнение Вами своих обязанностей, да\нет"></form:input>
                    <form:errors path="violation_complaints_considered"></form:errors>
                </div>
            </spring:bind>
            ...
            <spring:bind path="violation_intresting_information">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="violation_intresting_information" class="form-control"
...
со страхуемой деятельностью?"></form:input>
                    <form:errors path="violation_intresting_information"></form:errors>
                </div>
            </spring:bind>
...
со страхуемой деятельностью подробно"></form:input>
        ...
        <div style="width: 1080px;position: absolute;top:660px">
            ...
            <spring:bind path="insurance_before">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="insurance_before" class="form-control"
                                placeholder="Страховали ли Вы ранее гражданскую ответственность арбитражного управляющего?"></form:input>
                    <form:errors path="insurance_before"></form:errors>
                </div>
            </spring:bind>
...
страхования по..."></form:input>
        ...
        <div style="width: 1080px;position: absolute;top:660px">
            ...
            <spring:bind path="insurance_current">
                <div class="form27 ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="insurance_current" class="form-control"
                                placeholder="Страховали ли Вы ранее гражданскую ответственность арбитражного управляющего?"></form:input>
                    <form:errors path="insurance_current"></form:errors>
                </div>
            </spring:bind>
